(function () {
  ...
  var owlCarousel = function () {
    ...
    owl.owlCarousel({
      ...
      dots: false,
      navText: [
        `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="m21.5 28c-.256 0-.512-.098-.707-.293l-11-11c-.391-.391-.391-1.023 0-1.414l11-11c.391-.391 1.023-.391 1.414 0s.391 1.023 0 1.414l-10.293 10.293 10.293 10.293c.391.391.391 1.023 0 1.414-.195.195-.451.293-.707.293z" fill="#d7ff6a" stroke="#d7ff6a" stroke-width="1"/></svg>`,
        `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="m10.5 4c.256 0 .512.098.707.293l11 11c.391.391.391 1.023 0 1.414l-11 11c-.391.391-1.023.391-1.414 0s-.391-1.023 0-1.414l10.293-10.293-10.293-10.293c-.391-.391-.391-1.023 0-1.414.195-.195.451-.293.707-.293z" fill="#d7ff6a" stroke="#d7ff6a" stroke-width="1"/></svg>`
      ],
      responsive: {
        0: {
          items: 1,
